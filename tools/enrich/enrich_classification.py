...
{card("講義 04 · 用 2001–2004 配適、在 2005 年比較", _log_code3, lab_output(CH, 49),
      src=src("45、49、51"),
      note="用 2001–2004 配適、在 2005 年比較，正確率是 <strong>48.0%</strong>（錯誤率 52.0%，"
           "見儲存格 51）。不過前一張卡已用包含 2005 年的完整資料查看係數與 p 值；"
...
{card("講義 04 · QuadraticDiscriminantAnalysis", _qda_code, lab_output(CH, 95),
      ...
      note="<code>covariance_[0]</code>（儲存格 93）是<strong>第一類自己的</strong> Σ̂₁ = "
           ...
           "QDA 的 2005 年正確率 <strong>0.5992</strong>（儲存格 97／98），"
...
{card("講義 04 · KNeighborsClassifier(n_neighbors=1)",
      ...
      src=src("122、124"),
      note="K = 1 的 2005 年正確率剛好 <strong>0.500</strong>（儲存格 124）——完全等於丟硬幣。"
