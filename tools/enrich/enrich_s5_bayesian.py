...
BODIES["review"] = r"""
  ...
  <p>回顧 <a href="s2_conditional.html#bayes">S2 的篩檢算例</a>：盛行率 1%、敏感度 90%、
  偽陽性率 5% 時，陽性後的罹病機率約為 15.4%。這一頁接著把「更新事件機率」推進到
