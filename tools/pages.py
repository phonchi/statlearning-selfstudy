...
PAGES = [
    ...
    Page(
        ...
        h1='AI 都能分析了，<span class="orange">我為什麼還要學</span>？',
        plain="AI 時代的資料分析學習迴圈",
        subtitle="課前準備 A — 選讀，不列入評分",
        formula="提出想法｜動手嘗試｜觀察證據｜修正理解｜AI 參與每一步｜判斷不能外包",
        ...
        secs=[
            Sec("prologue", "AI 不只會寫程式", "它能參與整個資料分析流程，但不會替你學會",
                "先備 · AI 與資料分析", kicker="PROLOGUE · 開場"),
            Sec("loop", "學習迴圈", "想法、嘗試、證據、修正：四步都不能跳",
                "先備 · 學習迴圈"),
            Sec("workflow", "每一步都能請 AI 幫忙", "從找資料到報告草稿，重點不是禁用而是分工",
                "先備 · 資料分析流程"),
            Sec("judgment", "判斷不能外包", "資料代表什麼、流程站不站得住，仍然由你負責",
                "AI-Stats §11"),
            Sec("habits", "把 AI 留在迴圈裡", "五個習慣，讓協助變成學習而不是代工",
                "先備 · 學習策略"),
        ],
    ),
    Page(
    ...
    Page(
        ...
        secs=[
            ...
            Sec("triage", "先做任務分流", "可立即驗證的交給 AI，需要判斷的留在人手上",
                "AI-Stats §11"),
            Sec("context", "把問題包清楚", "方向、格式、例子、資料脈絡與驗收標準",
                "AI-Stats §10"),
