...
| # | 頁面 | 對應 | 內容量 |
|---|------|------|--------|
| 1 | [機率、平均與變異](s1_probability.html) | 先備 · S1 統計〔核心路徑〕 | 4 節 · 1 視覺區塊 · 20 張卡 |
| 2 | [條件機率與獨立](s2_conditional.html) | 先備 · S2 統計〔核心路徑〕 | 5 節 · 1 視覺區塊 · 20 張卡 |
| 3 | [分布與抽樣](s3_distributions.html) | 先備 · S3 統計〔核心路徑〕 | 5 節 · 2 視覺區塊 · 20 張卡 |
| 4 | [從樣本推論母體](s4_inference.html) | 先備 · S4 統計〔核心路徑〕 | 6 節 · 2 視覺區塊 · 22 張卡 |
| 5 | [貝氏推論〔選讀〕](s5_bayesian.html) | 先備 · S5 統計〔選讀〕 | 4 節 · 1 視覺區塊 · 20 張卡 |
| 6 | [相關與迴歸〔選讀〕](s6_regression.html) | 先備 · S6 統計〔選讀〕 | 4 節 · 1 視覺區塊 · 20 張卡 |
